"""Build the Phase 4 Robustness & OOS Testing Jupyter notebook."""
import json
from pathlib import Path

PROJECT = Path(__file__).resolve().parent.parent
nb_path = PROJECT / "notebooks" / "Phase4_Robustness_OOS.ipynb"
...
# ============================================================
# M9: ECONOMIC SIGNIFICANCE & PLACEBOS
# ============================================================
md([
    "---\n",
...
print(f"Phase 4 notebook written: {nb_path}")
